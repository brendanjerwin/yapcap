...
opencode-go-login-editing = Enter your OpenCode Go workspace and auth cookie
opencode-go-login-failed = OpenCode Go login failed
opencode-go-workspace-id-placeholder = Workspace ID
opencode-go-auth-cookie-placeholder = Auth cookie
ollama-cloud-accounts-title = Ollama Cloud Accounts
ollama-cloud-accounts-empty = No Ollama Cloud accounts
ollama-cloud-account-reauth-tooltip = Re-authenticate this Ollama Cloud account
ollama-cloud-login-editing = Enter your Ollama Cloud session cookie
ollama-cloud-login-failed = Ollama Cloud login failed
ollama-cloud-session-cookie-placeholder = Session cookie
...
provider-picker-all-section = More providers
provider-picker-connect-account = Connect account
