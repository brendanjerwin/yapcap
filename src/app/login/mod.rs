...
pub(crate) use flows::{
    ...
    MinimaxLoginFlow, OllamaCloudLoginFlow, OpencodeGoLoginFlow,
};

use super::{
    AntigravityLoginEvent, AppModel, ClaudeLoginEvent, CodexLoginEvent, Config, CopilotLoginEvent,
    GeminiLoginEvent, Handle, Message, MinimaxLoginEvent, OllamaCloudLoginEvent,
...
pub(crate) enum LoginEventKind {
    ...
    OllamaCloud(OllamaCloudLoginEvent),
}
